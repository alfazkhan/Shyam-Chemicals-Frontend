...
const Description = tw.p`mt-6 text-justify md:text-justify text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100`;
...
export default ({
  ...
  imageBorder = false,
  imageShadow = false,
  subheading = "Our Priority",
  heading = "Quality Assuarance",
  description = "At Shyam Chemicals & Minerals we pay utmost importance to quality. We make sure that the Industrial Minerals are quality tested on several parameters before their final dispatch. These tests are conducted by the experts at the testing unit.",
  textOnLeft = false,
  testimonials = [
    // {
    //   stars: 5,
